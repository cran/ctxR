...
In this introduction vignette, users will be introduced to different methods to access computational toxicology and exposure data. The two main methods described are through the CompTox Chemicals Dashboard and the CTX APIs via the R package *ctxR*. References to papers and additional information on resources can be found within the exposition of this document. For more detailed information on specific areas of data, please refer to the other vignettes included within *ctxR*. 
...
In this section, several ctxR functions are used to access different types of information from the [CTX Chemical API](https://comptox.epa.gov/ctx-api/docs/chemical.html).
...
In this section, several ctxR functions are used to access different types of information from the [CTX Hazard API](https://comptox.epa.gov/ctx-api/docs/hazard.html).
...
In this section, several ctxR functions are used to access different types of information from the [CTX Bioactivity API](https://comptox.epa.gov/ctx-api/docs/bioactivity.html).
...
```{r, bioactivity-dtxsid, eval=FALSE}
